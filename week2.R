...
wildschwein_BE <- mutate(wildschwein_BE,timelag = as.integer(difftime(DatetimeUTC, lag(DatetimeUTC), units = "secs")))
wildschwein_BE
...
plot(timelag~DatetimeUTC, wildschwein_BE)
...
roll_3 <- rollmean(caro$speed,k = 3,fill = NA,align = "left")
roll_3
roll_6 <- rollmean(caro$speed,k = 6,fill = NA,align = "left")
roll_9 <- rollmean(caro$speed,k = 9,fill = NA,align = "left")
